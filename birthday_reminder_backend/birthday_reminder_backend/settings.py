"""
Django settings for birthday_reminder_backend project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-oiv&5w%s1g)azxm!n!!li7#(75-58f6p)4&n26s6&ni1esj3(y')
...
ROOT_URLCONF = 'birthday_reminder_backend.urls'
...
WSGI_APPLICATION = 'birthday_reminder_backend.wsgi.application'
...
# Simplified static file serving for Koyeb
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = os.environ.get(
        ...
        'http://localhost:3000,https://brithday-reminder.onrender.com'
    ).split(',')
